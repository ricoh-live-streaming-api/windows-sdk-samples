...
public abstract class BehaviorBase : MonoBehaviour
{
    ...
    protected Vector2 localViewOriginalSize;
    protected Vector2 remoteViewOriginalSize;
    ...
    protected virtual void ShowRemoteView(string connectionId, VideoTrack videoTrack)
    {
        ...
        RemoteVideoRender = new VideoRender(UnityUIContext, remoteRenderTarget, remoteViewOriginalSize, videoTrack, connectionId);
    }
    ...
    protected abstract class ClientListenerBase : IClientListener
    {
        ...
        public virtual void OnAddLocalTrack(MediaStreamTrack mediaStreamTrack, MediaStream stream)
        {
            ...
            if (mediaStreamTrack is VideoTrack videoTrack)
            {
                ...
                app.LocalVideoRender = new VideoRender(app.UnityUIContext, app.localRenderTarget, app.localViewOriginalSize, videoTrack);
            }
        }
